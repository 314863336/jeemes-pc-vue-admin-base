  ...
  <div class="app-container">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="comments" label="表说明" align="left" />
        <el-table-column prop="parentTableName" label="父表名" align="left" />
        <el-table-column prop="functionAuthor" label="功能作者" align="left" />
        <el-table-column prop="createDate" label="创建时间" width="160" align="left" />
...
import { deleteLists } from '@/api/system/dictionary'
import { pageList, getTables, getDetail, deleteGen } from '@/api/tools/gen'
...
export default {
  ...
  methods: {
    ...
    findTableData() {
      this.loading = true
      this.form.parentTableName = this.tableName
      const searchParams = {
