<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="officeName" :show-overflow-tooltip="true" label="部门名称" align="left" />
      <el-table-column prop="fullName" :show-overflow-tooltip="true" label="部门全称" align="left" />
      <el-table-column prop="officeCode" :show-overflow-tooltip="true" label="部门编码" align="left" />
      <el-table-column prop="companyName" :show-overflow-tooltip="true" label="所属公司" align="left" />
      ...
      <el-table-column prop="actions" label="操作" width="300" align="left">
        <template slot-scope="scope">
          <el-button v-show="scope.row.officeType==='1'" type="primary" size="mini" title="编辑部门" @click="handleEdit(scope.row)">编辑</el-button>
          <el-button v-show="scope.row.officeType==='1'" slot="reference" type="danger" size="mini" title="删除部门" @click="handleDelete(scope.row)">删除</el-button>
          <el-button v-if="scope.row.officeType==='1'" type="primary" size="mini" title="新增下级部门" @click="handleAddSub(scope.row)">新增下级</el-button>
          <el-button v-else type="primary" size="mini" title="新增部门" @click="handleAddDept(scope.row)">新增部门</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    saveCorp() {
      this.$refs.officeForm.onSubmit()
    },
    cancelCorp() {
      this.$refs.officeForm.onCancel()
    }
  }
}
</script>
