    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20">
        ...
        >
          ...
          <el-table-column prop="email" :show-overflow-tooltip="true" label="电子邮箱" width="120" align="left" />
          <el-table-column prop="mobile" :show-overflow-tooltip="true" label="手机号码" width="120" align="left" />
          <el-table-column prop="phone" :show-overflow-tooltip="true" label="电话号码" width="120" align="left" />
          <el-table-column prop="remarks" :show-overflow-tooltip="true" label="备注" width="120" align="left" />
