<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button type="primary" plain @click="senEmail">测试发送消息</el-button>
    ...
    <div class="table-tools">
      <el-form inline>
        <el-form-item>
          <el-button type="primary" plain @click="changeReadStatus(false)">标记为已读</el-button>
          <el-button type="primary" plain @click="changeReadStatus(true)">全部标记为已读</el-button>
    ...
    >
      ...
      <el-table-column prop="sendUserName" :show-overflow-tooltip="true" label="发送人" align="left" />
      <el-table-column prop="readStatus" :show-overflow-tooltip="true" label="消息状态" align="left">
        <template slot-scope="scope">
          {{ getDict("message_read_status", scope.row.readStatus, true) }}
        </template>
      </el-table-column>
      <el-table-column prop="receiveDate" :show-overflow-tooltip="true" label="接收时间" align="left" />
